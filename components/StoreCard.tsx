...
export function StoreCard({ store }: Props) {
  return (
    <div class="bg-white ml-6 mt-6 shadow-md w-full sm:w-[45%] lg:w-[30%] relative">
      ...
      <div class="relative px-6 text-right storeCardHero">
        <div class="relative z-10 border-b-1 border-solid border-gray-50 mb-20 py-4 flex text-white items-center justify-around">
          <div>
            <svg
